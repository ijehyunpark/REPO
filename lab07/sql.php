...
<body style="text-align: center;">
	<div style="display: inline-block; border: 5px solid red; margin-top: 100px; padding: 50px;">
		<form action = '' method="post"  >
			<?php if(empty($_POST['username'])){ ?>
				<h1>MYSQL</h1>

				<div style="">
					<input type="text" name="username" placeholder="Input your Mysql username" class="form-control" autocomplete="off"/>
					<hr />
					<input type="text" name="password" placeholder="Input your Mysql password" class="form-control" autocomplete="off"/>
					<hr />
